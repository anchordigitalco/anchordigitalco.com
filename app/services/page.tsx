...
export const metadata: Metadata = {
  title: 'Services',
  description:
    'Website design and development, brand digital systems, and ongoing maintenance for businesses that want premium digital presence.',
}
...
export default function ServicesPage() {
  return (
    <>
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <p className="font-sans text-lg lg:text-xl text-charcoal-200 leading-relaxed max-w-2xl">
              Three core service areas, each built to move your business forward. No bloated retainers,
              no unnecessary complexity — just focused work that delivers results.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* CTA */}
      <section className="relative py-28 lg:py-36 overflow-hidden bg-charcoal-900">
        <div className="absolute inset-0 pointer-events-none">
          <div
