        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-start">
              <div>
                <div className="flex items-center gap-3 mb-6">
                  <span className="font-cormorant text-[6rem] lg:text-[8rem] font-300 leading-none select-none" style={{ color: 'rgba(43,127,255,0.08)' }}>
                    {service.number}
                  </span>
                </div>
                <h2 className="font-cormorant text-3xl lg:text-5xl font-500 text-cream mb-4 leading-tight">{service.title}</h2>
                <p className="font-sans text-base lg:text-lg text-charcoal-200 leading-relaxed mb-6">{service.description}</p>
                ...
                <Link href={service.ctaHref} className="btn-primary inline-flex items-center gap-2 font-sans text-sm px-7 py-4 rounded-xl">
